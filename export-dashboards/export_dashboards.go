// Copied with no modifications from https://github.com/elastic/beats/blob/v6.1.0/dev-tools/cmd/dashboards/export_dashboards.go
// Copyright Elastic under Apache 2.0
package main
